...
class App : KoinComponent {
    fun start() {
        ...
        val producto = productosController.findById(1).getOrThrow() // Si no existe el producto, se lanza una excepción
        ...
        ventasController.exportInvoice(venta1.getOrThrow())
        ...
        ventasController.exportInvoice(venta2.getOrThrow())
